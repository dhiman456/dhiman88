...
""" =======================CONSTANTS====================== """
pm_caption = f"**DhimanBot Is Up**\n"
pm_caption += f"**╭────────────**\n"
pm_caption += f"┣»»»『{mention}』«««\n"
pm_caption += f"┣Dʜɪᴍᴀɴ Bᴏᴛ ~ {legendversion}\n"
pm_caption += f"┣Dʜɪᴍᴀɴ  ~ [Owner](https://t.me/i_dxlvir)\n"
pm_caption += f"┣Sᴜᴘᴘᴏʀᴛ ~ [G𝖗ουρ](https://t.me/zxFighters)\n"
pm_caption += f"┣Cʜᴀɴɴᴇʟ ~ [Join](https:t.me/soul_x6)\n"
pm_caption += f"**╰────────────**\n"
